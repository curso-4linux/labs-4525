...
# Aqui temos uma condição que irá validar o return code do comando anterior (grep), caso o return code seja diferente de 0, ou seja, retornou com erro, a chave será concatenada ao final do arquivo authorized_keys. Caso ret
orne 0, que siginifica que rodou com sucesso, simplesmente será apresentada a mensagem "Chave já existe".
